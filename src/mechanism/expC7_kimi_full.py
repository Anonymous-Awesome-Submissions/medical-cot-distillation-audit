...
OUT_DIR = Path("experiments/module1/mechanism/internal_step_probe_kimi")
...
Q2 = "experiments/module1/q2_hallucination_full"
AUD = Q2 + "/audit_kimi_k26"
LAYERBAND = "experiments/module1/mechanism/layerband_eval"

# tag -> (model_path, cots_jsonl, audit_jsonl)
VAR = {
    "vanilla":  ("Qwen/Qwen3-8B",
                 f"{Q2}/vanilla_cot_medqa_full.jsonl", f"{AUD}/judgments_vanilla.jsonl"),
    "sft8b":    ("experiments/module1/qwen3_8b_sft_merged",
                 f"{Q2}/sft8b_cot_medqa_full.jsonl", f"{AUD}/judgments_sft8b.jsonl"),
    "weak_sft": ("experiments/module1/qwen3_8b_weak_teacher_merged",
                 f"{Q2}/weak_sft_cot_medqa_full.jsonl", f"{AUD}/judgments_weak_sft.jsonl"),
}
...
def main():
    ...
    ap.add_argument("--max-questions", type=int, default=1300)
