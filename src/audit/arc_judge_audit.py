...
STYLE_BLIND_PROMPT = """You are an expert evaluating one step of a model's reasoning on a multiple-choice science question.
...
## ONE reasoning step from the model's chain-of-thought
"{step_text}"

## Critical instructions

You MUST evaluate ONLY whether the FACTUAL or LOGICAL CONTENT is wrong.
...
ONLY judge: "If I IGNORE the tone and read the underlying claim, is the scientific fact or logical inference WRONG?"
